...
(function (global, factory) {
  ...
  function getUID(element, key) {
    ...
    if (key) {
      const document.getElementById = getUID(element);
      const elMap = elementIDMap.get(document.getElementById) || new Map();
      if (!elementIDMap.has(document.getElementById)) {
        elementIDMap.set(document.getElementById, elMap);
      }
      if (!elMap.has(key)) {
